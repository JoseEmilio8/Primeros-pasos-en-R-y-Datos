---
title: "Ejericios Ejemplo"
author: "Jose Emilio Vasconez"
output:
  html_notebook:
    theme: lumen
    toc: yes
...
A continuación, se presenta una selección de problemas. Respondan los problemas directamente en este documento. Cuando terminen, pueden tejer (knit) este documento a HTML y pueden enviarlo a mi correo. jvasconez@asig.com.edu
...
Vayan aquí:[R Markdown Themes Gallery](https://www.datadreaming.org/post/r-markdown-theme-gallery/)  y elijan un tema "preempaquetado" que se vea bien. Luego, apliquen ese tema a este documento agregando:
...
Muy bien. Ahora están listos para empezar con R. R es un lenguaje de programación ampliamente utilizado en la computación científica. Tiene funciones integradas para matemáticas, álgebra, estadística y muchas cosas más. Aprender R les permitirá poner experiencia en programación de computadoras en sus currículum vitae. Muchos puestos de analista y ciencia de datos esperan que los candidatos de la maravillosa Universidad San Francisco tengan experiencia en R.
...
Ahora, usen el menú desplegable al lado de Preview en la parte superior de esta ventana para Tejer a HTML. Renombren su archivo 01_SUNOMBRE.html y pueden enviarlo por correo. No ofrezco revisar todos los trabajos, pero podemos revisar las preguntas en la clase del próximo jueves. 
